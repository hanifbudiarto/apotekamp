 ...
 */
public class StokOpnameReport extends BaseReport {
     
    public void createReport () {
         try {
            ResultSet result = null;
            String query = "select kode_obat, nama_obat, satuan_obat, kategori_obat, stok from obat order by 1";
...
//                                                        Components.image(getClass().getResource("/resources/alamat-kop.png")).setHorizontalAlignment(HorizontalAlignment.RIGHT)
                                        ...
                                        Components.text("\nSTOK OBAT SEKARANG").setStyle(boldCenteredStyle)                                            
                                ),                            
                        Components.text("")
                )
            ...
            viewer.setTitle("Cetak Laporan Stok Obat Sekarang");
