 ...
 * @author hanif
 */
public class KodeObatSearchUI extends javax.swing.JFrame {

    /**
     * Creates new form KodeObatSearchUI
     */
    ISearch search;
    ArrayList<ArrayList<String>> allObat;
    
    public KodeObatSearchUI(ISearch search) {
        initComponents();
    ...
    private void initComboKodeNamaObat(){        
        ...
        String[] columns = new String[]{"Kode Obat", "Nama Obat"};
        int size = allObat.size();
        String[][] rows = new String[size][2];
        
        for (int i=0; i<size; i++) {
            rows[i][0] = allObat.get(i).get(0);
            rows[i][1] = allObat.get(i).get(1);
        }        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        search.setCbKodeObat(tblObat.getValueAt(tblObat.getSelectedRow(), 0).toString());
